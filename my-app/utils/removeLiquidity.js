...
*/
export const removeLiquidity = async(signer, removeTokensWei) => {
   const exchangeContract = new Contract(
       EXCHANGE_CONTRACT_ADDRESS,
       EXCHANGE_CONTRACT_ABI,
       signer
   );
   const tx = await exchangeContract.removeLiquidity(removeTokensWei);
    await tx.wait();
};
...
export const getTokensAfterRemove = async(
    ...
    // Get the total suppgly of `Crypto Dev` LP tokens
